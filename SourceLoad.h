...
#include	"ResourceSourceLoad.h"
#include	"Resource.h"

class SourceLoadEM : public ResourceSourceLoad{ 
	public:
		SourceLoadEM( Resource * ,SourceLoadEM * o=0);
...
class Source : public SourceLoadEM{
	public:
		Source( Resource * ,Source * o=0);
		AnalogResourceContext * clone(Resource *);
				
	private:
};

class Load : public SourceLoadEM{
	public:
		Load( Resource * , Load * o = 0 );
		AnalogResourceContext * clone(Resource *);
